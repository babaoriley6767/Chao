function hdr =  SaveDataNihonKohden_chao(sbj_name, project_name, block_name, dirs, refChan, epiChan, emptyChan)
...
%     fprintf('the recording time for %s of block %s in %s is %s, %s \n',sbj_name,bn,project_name,hdr.starttime,hdr.startdate)
