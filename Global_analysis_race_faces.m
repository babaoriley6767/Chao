...
% define the cohort
sbj_names_all = {'C18_32';'C18_33';'C18_34';'C18_35';'C18_37';'C18_38';'C18_39';'C18_40';'C18_41';'C18_42';'C18_43';'C18_44'...
    ;'C18_45';'C18_46';'C18_47';'C18_49';'C19_50';'C19_52';'C19_53';'C19_55';'C19_58';'S20_149_DR'};

%make a specific selection of cohort
sbj_names = sbj_names_all(1:21);%China
sbj_names = sbj_names_all(22:end);%Stanford
