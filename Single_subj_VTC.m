...
% define the cohort
sbj_names_all = {'S17_118_TW'};
sbj_names_all = {'S20_152_HT'};
sbj_names_all = {'S20_148_SM'};
...
channame = {'S17_118_TW-LCINm4'};
anat = {[72]};
T3 = table(anat);
T3.Properties.RowNames = {'S17_118_TW'};

channame = {'S20_152_HT-RB4'};
anat = {[106]};
T3 = table(anat);
T3.Properties.RowNames = {'S20_152_HT'};

channame = {'S20_148_SM-STE9'};
anat = {[119]};
T3 = table(anat);
T3.Properties.RowNames = {'S20_148_SM'};
...
% plot_params.legendfontsize = 40;
plot_params.single_trial_replot = true;
plot_params.single_trial_thr = 50;%the threshold of HFB it could be like 10 15 20 ...
...
conditions = {'faces','words','bodies','objects','numbers','falsefonts','buildings_scenes','scrambled_images'}; column = 'condNames'
load cdcol.mat
...
if plot_params.clust_per
    ...
    data_faces = plot_data{1}(:,indx_per);
    data_faces = permute(data_faces,[3 2 1]);
    data_others = plot_data{2}(:,indx_per);
    data_others  = permute(data_others,[3 2 1]);
    ...
    cond_names_stac{1,1} = 'face';
    cond_names_stac{1,2} = 'others';
    cond_names_stac{1,3} = 'face vs others';
else
end
