...
anat = {'INSULA','IFS','IFG','SFS','SFG','ACC','MCC'};anat_name = 'ROL race';
...
save('/Users/chao/Documents/Stanford/code/lbcn_personal-master/Chao/mat_files/group_diff_encoding_HFB_reall_behav_sheet_encode_correct.mat','HFB_behav_mix','HFB_behav_stats','plot_params','ROL_params','stats_params','data_time')
